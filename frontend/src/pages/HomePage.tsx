...
export function HomePage() {
  ...
  return (
    <div className="min-h-screen geometric-bg flex flex-col">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="relative hidden md:block">
                <div className="grid grid-cols-2 gap-3 sm:gap-4">
                  {/* Large preview top */}
                  <div className="col-span-2 aspect-video bg-secondary-bg/70 backdrop-blur-sm rounded-xl border border-border-color overflow-hidden group hover:border-accent-primary transition-all duration-300 shadow-glass">
                  ...
                  {[1, 2].map((i) => (
                    <div
                      key={i}
                      className="aspect-square bg-secondary-bg/70 backdrop-blur-sm rounded-xl border border-border-color overflow-hidden group hover:border-accent-primary transition-all duration-300 shadow-glass"
                    >
                      <div className="w-full h-full flex items-center justify-center">
                        <svg
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {demos.map((demo, index) => (
                <div
                  key={index}
                  className="bg-secondary-bg/70 backdrop-blur-sm rounded-xl border border-border-color overflow-hidden group hover:border-accent-primary transition-all duration-300 shadow-glass"
                >
                  {/* Demo Icon */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="bg-secondary-bg/70 backdrop-blur-sm rounded-xl p-6 sm:p-8 border border-border-color hover:border-accent-primary transition-all duration-300 shadow-glass"
                >
      ...
      {/* Footer */}
      <footer className="border-t border-color bg-secondary-bg/50 backdrop-blur-sm">
